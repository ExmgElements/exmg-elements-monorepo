...
@customElement('exmg-form-drawer-demo-dismissible')
export class DrawerDismissible extends LitElement {
  ...
  render () {
    ...
    return html`
      <exmg-form-drawer hasheader="" type="dismissible" ?open="${this.open}" @MDCDrawer:closed="${this.onDrawerClosed}">
        ...
        <div slot="appContent">
          <input type="button" @click="${this.toggleDrawer}" value="Toggle drawer">
