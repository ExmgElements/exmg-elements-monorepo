export const menu = [
  {
    ...
    iconPath: 'M15 7.5V2H9v5.5l3 3 3-3zM7.5 9H2v6h5.5l3-3-3-3zM9 16.5V22h6v-5.5l-3-3-3 3zM16.5 9l-3 3 3 3H22V9h-5.5z',
    title: 'Games',
  },
  {
    title: 'Manage',
  ...
  },
  {
    ...
    items: [
      ...
      {
        path: 'banners/',
        iconPath: 'M23 18V6c0-1.1-.9-2-2-2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2zM8.5 12.5l2.5 3.01L14.5 11l4.5 6H5l3.5-4.5z',
        title: 'Banners',
      },
      {
        path: 'notifications/',
