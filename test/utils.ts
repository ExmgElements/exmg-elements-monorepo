...
export const onExmgGridToolbarActionExecuted: (element: LitElement, shouldResolve: boolean) =>
  Promise<any> = onEvent('exmg-grid-toolbar-action-executed');

export const onExmgGridToolbarFilterChanged: (element: LitElement, shouldResolve: boolean) =>
  Promise<any> = onEvent('exmg-grid-toolbar-filter-changed');
